<template>
  ...
  <div class="m-10">
    ...
    <br>
    <div v-if="remainingTodos > 0" class="text-3xl"> {{ remainingTodos }} tâche{{ remainingTodos > 1 ? "s" : "" }} à faire

    </div>
    <Checkbox label="waffo" />
    <Checkbox label="Rosto" class="text-green-600" />
  </div>
</template>

<script setup>
import { ref, computed } from 'vue';
import Checkbox from './Checkbox1.vue';
